  ...
  return (
    <div className="landing-content">
      <h1 className="landing-title">
        <span ref={landingTitleRef1}>Hello!</span>{" "}
        <span ref={landingTitleRef2}>I'm</span>{" "}
        <span ref={landingTitleRef3} className="name">
          Vinod.
        </span>
      </h1>
      <p className="paragraph-1" ref={paragraph1Ref}>
      ...
      <p className="paragraph-2" ref={paragraph2Ref}>
